...
public class TopTenWords {
    ...
    public static class Map extends Mapper<Object, Text, Text, IntWritable>{
        ...
        public void maps(Object llave, Text valor, Mapper<Object, Text, Text, IntWritable>.Context contexto)
        ...
        // @Override
        protected void contarMap(Context context) throws IOException, InterruptedException {
            for (java.util.Map.Entry<Integer, String> entry : contadorpalabraMap.entrySet()) {
    ...
    public static class Reduce extends Reducer<Text, IntWritable, Text, IntWritable>{
        ...
        public void reduce(Text llave, Iterable<IntWritable> valores,
            ...
            for (java.util.Map.Entry<IntWritable, Text> entry : contadorpalabraMap.descendingMap().entrySet()) {
